...
/*function checkDeadline() {
    if (newDeadline < 3) {
        taskList.className += "alert-danger";
    }
    else if (newDeadline < 7 && newDeadline > 3) {
        taskList.className += "alert-warning";
    }
    else if (newDeadline >= 7) {
        taskList.className += "alert-secondary";
    }
    // taskList.innerHTML += ""
    //document.getElementById("submittedTask").innerHTML += "alert-danger";
...
function addTask() {
   ...
   //document.getElementById("addedTasks").innerText = (newTask + "<br>" + newDeadline + " days");
    ...
    if (newDeadline < 3) {
        taskList.innerHTML += "<div class='col-auto mr-2 alert alert-danger alert-dismissable fade show'>"
        + newTask + "<br>" + newDeadline + " day(s)" + "</div>";
    }
    else if (newDeadline < 7 && newDeadline > 2) {
        taskList.innerHTML += "<div class='col-auto mr-2 alert alert-warning alert-dismissable fade show'>" +
            newTask + "<br>" + newDeadline + " day(s)" + "</div>";
    }
    else if (newDeadline >= 7) {
        taskList.innerHTML += "<div class='col-auto mr-2 alert alert-secondary alert-dismissable fade show'>" +
            newTask + "<br>" + newDeadline + " day(s)" + "</div>";
    }
    //checkDeadline();
...
function validateForms() {
    ...
    if (inputTaskName === "") {
        ...
        inputTaskName.parentElement.className = "form-group has error";
